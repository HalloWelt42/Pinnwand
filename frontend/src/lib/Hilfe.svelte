<script lang="ts">
  ...
  const THEMEN: Thema[] = [
    ...
    { titel: 'Flow', text: 'Aufgaben als Boxen, frei anordenbar. Verknuepfen-Modus zieht Abhaengigkeiten (blockierende zuerst, dann abhaengige Karte). Blockierte Karten sind rot.' },
